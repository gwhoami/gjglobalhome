...
const GeneralForm = React.memo(
  ({
    ...
    const completeHandler = (event) => {
        generalAddedList.current[recordIndex].documents.push({
    ...
    const saveGeneral = () => {
        ...
        : [
            {
              _modal: 'EventList',
              _condition: 'update',
              _find: { _id: pageData.current._id, 'general.id': arr.id },
              _data: { $set: { 'general.$': arr } },
      ...
      (async () => {
        ...
        if (res.isError) {
          ...
          ToastMessage({
            type: 'success',
            message: 'General added succesfully!',
            timeout: 1200,
          });
        }
      })();
    ...
    const openFileUpload = () => {
      if (typeof formRef.current.saved !== 'undefined') {
        ToastMessage({
          type: 'error',
          message: 'Save the General Details and upload!',
          timeout: 1200,
        });
        return;
      }
    ...
    const removeGeneral = () => {
      if (generalAddedList.current[recordIndex].saved === false) {
        alertRef.current.showConfirm(
          ...
          'Confirm?',
          'Are you sure to delete this General Details?'
        );
      } else {
        alertRef.current.showConfirm(
          (res) => {
            ...
            let params = [
              {
                ...
                _condition: 'update',
                _find: { _id: pageData.current._id },
                _data: { $pull: { general: { id: formRef.current.id } } },
              },
            ];
            ...
            <form>
              ...
              <div className="flex w-full justify-start items-center relative">
                ...
                <div className="w-1/3 mr-5">
                  <GroupInput
                    ...
                    required="Year of Exp is required"
                    icon={faUser}
                  />
                  {/* <DatePicker
                    styleClass="flex flex-col mb-4"
              ...
              <div className="flex w-full justify-start items-center mt-3">
                ...
                <div className="w-1/3  mr-5">
                  ...
                  <input
                    type="text"
                    readOnly={true}
                    value={Constants.getAge(formRef.current.dob)}
              ...
              <div className="flex w-full justify-start items-center mt-3">
                ...
                <div className="w-1/3 mr-5">
                  <InputSelect
                    ...
                    label="Rate Level"
                    placeholder="--Select--"
                    options={formList.rateLevel}
                    required="Rate Level is required"
                  />
                </div>
                ...
                <div className="w-1/3 mr-5">
                  <GroupInput
                    ...
                    required="Total Event is required"
                    icon={faUser}
                  />
                </div>
              </div>
              <div className="flex w-full justify-start items-center mt-3">
                <div className="w-1/3 mr-5">
                  <GroupInput
                    styleClass="flex flex-col mb-4"
                    formKey="avgeventPrice"
                    formRef={formRef}
                    uiRefresh={ui}
                    label="Average Event Price"
                    placeholder="Average Event Price"
                    required="Average Event Price is required"
                ...
                <div className="w-1/3 mr-5">
                  <GroupInput
                    ...
                    required="Fax Address is required"
                    icon={faCircleDollarToSlot}
                  />
                </div>
                <div className="w-1/3 mr-5">
